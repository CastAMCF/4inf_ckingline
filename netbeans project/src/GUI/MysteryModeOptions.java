...
/**
 * Inicia as opções do modo mistério
 * @author Asus
 */
public class MysteryModeOptions extends JFrame implements ComponentListener {
	...
	public MysteryModeOptions() {
		...
		try {
			...
			if(!newgameop) {
				while (BeginGameMyst.getTimeMusic() > (34360748*count1)) {
					count++;
					count1++;
					count2 = count;
					count3 = count1;
				}
				clip.setMicrosecondPosition(BeginGameMyst.getTimeMusic() - (34360748*count));
			}else {
	...
	private void begin() {
		...
		selected = 0;
		listening = false;
		BeginGameMyst.setSinglePlayerOption(true);
		
		BeginGameMyst.setX(numlines);
		BeginGameMyst.setY(numcolumns);
		BeginGameMyst.setLinha(numcheck);
		BeginGameMyst.setJogador1nome(txtJogador_1.getText());
		BeginGameMyst.setJogador2nome(txtJogador_2.getText());
		BeginGameMyst.setJogador3nome(txtJogador_3.getText());
		BeginGameMyst.setJogador4nome(txtJogador_4.getText());
		BeginGameMyst.setImage1("ball" + ballimagenum1 + ".png");
		BeginGameMyst.setImage2("ball" + ballimagenum2 + ".png");
		BeginGameMyst.setImage3("ball" + ballimagenum3 + ".png");
		BeginGameMyst.setImage4("ball" + ballimagenum4 + ".png");
		
		BeginGameMyst.setPlayer1("#");
		if(numbots == 3) {
			BeginGameMyst.setPlayer2("@");
			BeginGameMyst.setPlayer3("&");
			BeginGameMyst.setPlayer4("$");
		}else if(numbots == 2) {
			BeginGameMyst.setPlayer2("@");
			BeginGameMyst.setPlayer3("&");
			BeginGameMyst.setPlayer4("");
	...
	private void back() {
		...
		clipTimePostion = clip.getMicrosecondPosition();
		clip.stop();
		NewGameOptions.setMysterymode(true);
