		        		...
		        		if (ke.getKeyCode() == KeyEvent.VK_RIGHT) {
		        			...
		        			if(singleplayer) {
                        		if(selected == 2) {
	                        		...
	                        		API.Images.setImage(btnonline, getClass().getResource("/multimedia/imagens/button_online_entered.png"));
	                        		...
	                        		API.Images.setImage(btnonline, getClass().getResource("/multimedia/imagens/button_online_exited.png"));
	                        		API.Images.setImage(btnsingleplayer, getClass().getResource("/multimedia/imagens/button_singleplayer_exited.png"));
	                        		API.Images.setImage(btnback, getClass().getResource("/multimedia/imagens/button_back_exited.png"));
	                        		singleplayer = false;
	                        		multiplayer = true;
